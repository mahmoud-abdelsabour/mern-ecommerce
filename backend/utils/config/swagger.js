    ...
    components: {
      ...
      schemas: {
        ...
        ReturnInfo: {
          type: 'object',
          properties: {
            returnedItems: { type: 'array', items: { $ref: '#/components/schemas/ReturnItem' } },
            returnDate: { type: 'string', format: 'date-time', nullable: true }
          },
          example: {
            returnedItems: [{ product: '64f0c2a1d9f3a2a1b0c55555', quantity: 1, reason: 'Damaged' }],
            returnDate: null
          }
        },
        Order: {
        ...
        PaginationProducts: {
          ...
          example: { totalProducts: 100, totalPages: 10, currentPage: 1, limit: 10, hasMore: true }
        },
        PaginationOrders: {
          type: 'object',
          properties: {
          ...
          example: { totalOrders: 20, totalPages: 2, currentPage: 1, limit: 10, hasMore: true }
        },
        PaginationBrands: {
          type: 'object',
          properties: {
          ...
          example: { totalBrands: 5, totalPages: 1, currentPage: 1, limit: 10, hasMore: false }
        },
        PaginationCategories: {
          ...
          example: { totalCategories: 8, totalPages: 1, currentPage: 1, limit: 10, hasMore: false }
        },
        PaginationUsers: {
          type: 'object',
          properties: {
          ...
          example: { totalUsers: 50, totalPages: 5, currentPage: 1, limit: 10, hasMore: true }
        },
        PaginationReviews: {
          type: 'object',
          properties: {
        ...
        ProductsListResponse: {
          ...
          example: {
            ...
            pagination: { totalProducts: 1, totalPages: 1, currentPage: 1, limit: 10, hasMore: false }
          }
        },
        OrdersListResponse: {
          type: 'object',
          ...
          example: {
            ...
            pagination: { totalOrders: 1, totalPages: 1, currentPage: 1, limit: 10, hasMore: false }
          }
        },
        AdminOrdersListResponse: {
          type: 'object',
          properties: {
            orders: { type: 'array', items: { $ref: '#/components/schemas/OrderCard' } },
            pagination: { $ref: '#/components/schemas/PaginationOrders' }
          },
          example: {
            orders: [
        ...
        BrandsListResponse: {
            ...
            brands: {
              ...
              items: {
                allOf: [
                  ...
                  { type: 'object', properties: { productsCount: { type: 'number' } } }
                ]
              }
            },
          ...
          example: {
            ...
            pagination: { totalBrands: 1, totalPages: 1, currentPage: 1, limit: 10, hasMore: false }
          }
        },
        CategoriesListResponse: {
          ...
          example: {
            ...
            pagination: { totalCategories: 1, totalPages: 1, currentPage: 1, limit: 10, hasMore: false }
          }
        },
        UsersListResponse: {
          type: 'object',
          ...
          example: {
            ...
            pagination: { totalUsers: 1, totalPages: 1, currentPage: 1, limit: 10, hasMore: false }
          }
        },
        ReviewsListResponse: {
          type: 'object',
        ...
        ProductDetailResponse: {
          ...
          properties: {
            ...
            reviewsPreview: { type: 'array', items: { $ref: '#/components/schemas/Review' } },
